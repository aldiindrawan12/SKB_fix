                    ...
                    <table class="table table-bordered" id="Table-Truck-Kir" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="40%" scope="col">Berlaku No KIR</th>
                                <th class="text-center" width="30%" scope="col">Sisa Berlaku</th>
                            </tr>
                        </thead>
                        <tbody>
                    ...
                    <table class="table table-bordered" id="Table-Supir-Tidak-Jalan" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="20%" scope="col">Alamat</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
    ...
    <script> //script datatables kendaraan
        $(document).ready(function() {
            ...
            table = $('#Table-Truck').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo base_url('index.php/dashboard/view_truck/nopol') ?>",
                    "type": "POST",
                },
                "deferRender": true,
                "paging":false,
    ...
    <script> //script datatables kendaraan
        $(document).ready(function() {
            var table = null;
            table = $('#Table-Truck-Stnk').DataTable({
                "processing": true,
                "serverSide": true,
                "ordering": true,
                "order": [
                ...
                "ajax": {
                    "url": "<?php echo base_url('index.php/dashboard/view_truck/stnk') ?>",
                    "type": "POST",
                },
                "deferRender": true,
                "paging":false,
    ...
    <script> //script datatables kendaraan
        $(document).ready(function() {
            var table = null;
            table = $('#Table-Truck-Kir').DataTable({
                "processing": true,
                "serverSide": true,
                "ordering": true,
                "order": [
                ...
                "ajax": {
                    "url": "<?php echo base_url('index.php/dashboard/view_truck/kir') ?>",
                    "type": "POST",
                },
                "deferRender": true,
                "paging":false,
    ...
    <script> //script datatables kendaraan
        $(document).ready(function() {
            var table = null;
            table = $('#Table-Truck-Ijin-Bongkar').DataTable({
                "processing": true,
                "serverSide": true,
                "ordering": true,
                "order": [
                ...
                "ajax": {
                    "url": "<?php echo base_url('index.php/dashboard/view_truck/ijin') ?>",
                    "type": "POST",
                },
                "deferRender": true,
                "paging":false,
    ...
    <script> //script datatables kendaraan
        ...
        $(document).ready(function() {
            ...
            table = $('#Table-Supir-Sim').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo base_url('index.php/dashboard/view_supir/sim') ?>",
                    "type": "POST",
                },
                "deferRender": true,
                "paging":false,
